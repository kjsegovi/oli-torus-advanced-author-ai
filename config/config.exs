...
config :oli,
  ...
  openstax_web_research_enabled: false,
  openstax_three_d_generation_enabled: false,
  openstax_generated_simulation_delivery_enabled: false,
  openstax_generated_simulation_kill_switch: true,
  openstax_research_approved_edu_domains: [],
  ...
  openstax_generated_simulation_response_headers_enforced: false,
  openstax_generated_simulation_frame_ancestors: [],
  openstax_generated_simulation_bucket_name: nil,
  openstax_generated_simulation_readiness_required: false,
  openstax_generated_simulation_readiness_interval_ms: 30_000,
  generated_simulation_origins: [],
  openstax_ai_cost_guard_enabled: true,
  openstax_ai_lesson_limit_cents: 300,
  openstax_ai_simulation_limit_cents: 1_000,
  openstax_ai_import_warning_cents: 10_000,
  openstax_ai_import_stop_cents: 20_000,
  openstax_ai_daily_stop_cents: 100_000,
  openstax_course_import_max_parallel_lessons: 3,
  openstax_codex_poc_enabled: false,
  openstax_codex_proxy_url: "http://127.0.0.1:4001",
  openstax_codex_proxy_token: nil,
  openstax_course_import_lesson_planning_strategy: :parallel_v1,
  openstax_course_import_approve_all_enabled: Mix.env() in [:dev, :test],
  openstax_course_import_test_conveniences_enabled: false,
